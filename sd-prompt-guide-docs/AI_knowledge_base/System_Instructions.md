...
📘 基礎篇
- `00-quick-tips.md` — 常見實用小技巧（快速入門）
- `01-why-default-girls.md` — 解釋為什麼模型預設畫女生
- `02-drawing-males.md` — 畫男性角色的完整指南
- `03-no-humans.md` — 純風景/純物件的技巧
- `04-multi-character.md` — 多角色構圖控制
- `05-recommended-models.md` — 推薦 SDXL 模型列表
- `06-tag-lookup.md` — 常用 tag 中英對照表
- `07-male-tags.md` — 男性 tag 大全

🔧 進階技術
- `08-lora-basics.md` — LoRA 基礎與疊加技巧
- `08b-lora-training.md` — 在 PixAI 上訓練自己的 LoRA
...
- `13-dream-pictures.md` — 夢圖指南
- `14-otome-pov.md` — 乙女遊戲 CG 指南

📎 其他
- `pixai-credits-guide.md` — PixAI 點數取得方式
- `15-references.md` — 參考資料與延伸閱讀
...
| 新手入門、快速技巧 | `00-quick-tips.md` |
| 為什麼都是女生 | `01-why-default-girls.md` |
| 畫男生、男性角色 | `02-drawing-males.md` + `07-male-tags.md` |
| 畫風景、物件、no humans | `03-no-humans.md` |
| 多人、多角色構圖 | `04-multi-character.md` |
| 推薦 SDXL 模型 | `05-recommended-models.md` |
| LoRA 怎麼用 | `08-lora-basics.md` |
| 訓練 LoRA、自訓模型 | `08b-lora-training.md` |
| 加速、LCM、PCM | `09-acceleration-lora.md` |
| 放大、HiRes、Upscale | `10-hires-upscale.md` |
| Inpaint、Outpaint、局部修改 | `11-inpaint-outpaint.md` |
